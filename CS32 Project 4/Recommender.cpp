                ...
                if (!It.is_valid())
                {
                    ...
                    for (int k = 0; k < candidate.size(); k++)
                    {
                        if (candidate[k].movie.movie_id == Id)
                        {
                            ...
                            //cout << candidate[k].title << " add " << num * base << endl << "current score: " << candidate[k].movie.compatibility_score << endl << endl;
                            check = true;
                            break;
                        }
                    }
                    if (!check)
                    {
                        ...
                        //cout << a.title << " created and add " << num * base << endl << "current score: " << num * 20 << endl << endl;
                    }
                }
            }
        }
