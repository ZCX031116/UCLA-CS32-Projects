...
private:
    ...
    void load_helper(std::string id, std::string title, std::string release_year, std::string directors,
        std::string actors, std::string genres, std::string Rating);
    void Clear(std::string& id, std::string& title, std::string& release_year, std::string& directors,
        std::string& actors, std::string& genres, std::string& Rating);
};
